...
const HeartDiseasePredictor=()=>{
    ...
    const handleSubmit=(e)=>{
       ...
       if(formData.chestPainType=="Typical Angina")
        ...
        const bloodSugarNumeric=formData.fastingBloodSugar==="Greater than 120 mg/dl"? 1:0;

        const ecgNumeric=formData.restingECGresults==="Normal"?0: formData.restingECGresults==="Having ST-T wave abnormality"? 1: 2;

        const exerciseanNumeric=formData.exerciseInducedAngina==="Yes"?1:0;

        const slopeSegment=formData.slopeOfPeakExSTsegment==="Upslopping"?0:
        formData.slopeOfPeakExSTsegment==="Flat"?1: 2;

        const thalaNumeric=formData.thalassemia==="Normal"?3: formData.thalassemia==="Fixed Defect"?6:7;
                ...
                <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-tl from-green-400 to-blue-500 p-6">
                    ...
                    <div className="form-group mb-4">
                        ...
                        className="w-full border border-gray-300 rounded-md p-2">
                            ...
                            <option value="other">Probable or definite left ventricular hypertrophy by Estes' criteria</option>
                        </select>
                    </div>
                ...
                <label className="flex items-center">
                   ...
                   <div className="form-group mb-4">
                    ...
                    <div className="form-group mb-4">
                        ...
                        <select name="slopeOfPeakExSTsegment"
